...
local patchSize        = 8;
local stride           = 2;
local displayPeriod    = 8000;   --Number of timesteps to find sparse approximation
...
local inputPath        = "/home/ncarlson/cifar-10-batches-mat/test_batch_randorder.txt";
...
local dictionaryFile   = "/home/ncarlson/run/training/Checkpoint/V1ToInputError_W.pvp";   --nil for initial weights, otherwise, specifies the weights file to load.
...
local VThresh          = 0.55;  -- .005; --The threshold, or lambda, of the network
local AMin             = 0;
local AMax             = infinity;
