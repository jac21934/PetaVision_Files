...
package.path = package.path .. ";" .. "/home/jcarroll/OpenPV/parameterWrapper/?.lua";
local pv = require "PVModule";

if ((arg[1] == nil) or (arg[2] == nil)) then
	 print("ERROR\n")
	 print("Usage: lua " .. arg[0] .. " <VTHRESH>  <NUMFEATURES>");
	 return -1;
end


local VThresh          = tonumber(arg[1]);  -- .005; --The threshold, or lambda, of the network
...
local inputPath        = "/home/jcarroll/CIFAR/cifar-10-batches-mat/test_batch_randorder.txt";
...
local dictionaryFile   = "/home/jcarroll/Trained_Weights/CIFAR/nf_" .. dictionarySize .. "/VThresh_" .. VThresh .. "/V1ToInputError_W.pvp";   --nil for initial weights, otherwise, specifies the weights file to load.
